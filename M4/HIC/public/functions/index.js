...
exports.storePostData = functions.https.onRequest((request, response) => {
 cors(request,response,function(){
     ...
     formData.parse(request,function(err,fields,files){
        ...
        var bucket = gcs.bucket('heyic-d4dff.appspot.com');
           ...
           uploadType: 'media',
            ...
            if(!err){
                admin.database().ref('posts').push({
                    ...
                    .then(function() {
                        webpush.setVapidDetails('mailto:michael.leopold@mlphomeuse.de', 'BP1W_rUqd1QmE88JWwBGqpPefA8rpheoz9CrrS2aRoQh1PDEnmf-H6Xl_nO13szK9V4TX-ZIsUsKauseVLg0fE8','NDazJcyFEwiivUf7U4ZOoL7lHnMpcniGZ2hmcbTFDcE');
...
admin.initializeApp({
    credential: admin.credential.cert(serviceAccount),
    databaseURL: "https://heyic-d4dff.firebaseio.com/"
});
                        ...
                        admin
                            ...
                            .then(function() {
                                webpush.setVapidDetails(
                                    "mailto:michael.leopold@mlphomeuse.de",
                                    "BP1W_rUqd1QmE88JWwBGqpPefA8rpheoz9CrrS2aRoQh1PDEnmf-H6Xl_nO13szK9V4TX-ZIsUsKauseVLg0fE8",
                                    "NDazJcyFEwiivUf7U4ZOoL7lHnMpcniGZ2hmcbTFDcE"
                                );
                                return admin
                                    .database()
                                    .ref("subscriptions")
